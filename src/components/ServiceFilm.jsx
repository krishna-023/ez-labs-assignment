...
export default function ServiceFilm({ onClose }) {
  return (
    <motion.section
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="mt-6 text-gray-700 leading-relaxed">
            We craft cinematic experiences that breathe emotion, tell stories,
            and leave audiences inspired. From script to screen, we build films
            that move people and create impact.
          </p>

          <ul className="mt-4 list-disc ml-6 text-gray-700 space-y-1">
            <li>Film & Ad Production</li>
            <li>Concept Development</li>
            <li>Direction & Editing</li>
